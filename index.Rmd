...
These plots compare ASCI scores with the macroinvertebrate California Stream Condition Index (CSCI) scores (Mazor et al., 2016). The top plots show simple correlations between ASCI scores and the CSCI, whereas the bottom plot shows the difference between ASCI and CSCI scores. Blue lines show the linear fit in each plot, whereas the dotted line shows the 1:1 line in the top plots and the zero line in the bottom plots.
